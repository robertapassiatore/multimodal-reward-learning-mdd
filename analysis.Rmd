---
title: "Multimodal Reward Learning (MDD) — Reproducible analysis"
output:
  github_document:
    toc: true
    toc_depth: 2
...
> If you want to use your private Excel instead, keep it local and do **not** commit it to a public repo.
